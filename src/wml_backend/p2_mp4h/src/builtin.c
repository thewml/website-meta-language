...
builtin_tab[] =
{
  ...
  { "__file__",         false,    true,   ((myfunc_type)(mp4h_bp___file__)) },
  { "__line__",         false,    true,   ((myfunc_type)(mp4h_bp___line__)) },
  { "__version__",      false,    true,   ((myfunc_type)(mp4h_bp___version__)) },
  { "lb",               false,    true,   ((myfunc_type)(mp4h_bp_lb)) },
  { "rb",               false,    true,   ((myfunc_type)(mp4h_bp_rb)) },
  { "dq",               false,    true,   ((myfunc_type)(mp4h_bp_dq)) },
  { "bs",               false,    true,   ((myfunc_type)(mp4h_bp_bs)) },
  { "timer",            false,    true,   ((myfunc_type)(mp4h_bp_timer)) },
  { "mp4h-l10n",        false,    true,   ((myfunc_type)(mp4h_bp_mp4h_l10n)) },
  { "mp4h-output-radix",false,    true,   ((myfunc_type)(mp4h_bp_mp4h_output_radix)) },
  { "date",             false,    true,   ((myfunc_type)(mp4h_bp_date)) },

      /*  debug functions  */
  { "debugmode",        false,    true,   ((myfunc_type)(mp4h_bp_debugmode)) },
  { "debugfile",        false,    true,   ((myfunc_type)(mp4h_bp_debugfile)) },
  { "function-def",     false,    true,   ((myfunc_type)(mp4h_bp_function_def)) },
  { "debugging-off",    false,    true,   ((myfunc_type)(mp4h_bp_debugging_off)) },
  { "debugging-on",     false,    true,   ((myfunc_type)(mp4h_bp_debugging_on)) },

  /*  file functions  */
#ifdef HAVE_FILE_FUNCS
  { "get-file-properties", false, true,   ((myfunc_type)(mp4h_bp_get_file_properties)) },
  { "directory-contents",  false, true,   ((myfunc_type)(mp4h_bp_directory_contents)) },
  { "file-exists",         false, true,   ((myfunc_type)(mp4h_bp_file_exists)) },
  { "real-path",           false, true,   ((myfunc_type)(mp4h_bp_real_path)) },
#else
  { "get-file-properties", false, true,   ((myfunc_type)(mp4h_bp_unsupported)) },
  { "directory-contents",  false, true,   ((myfunc_type)(mp4h_bp_unsupported)) },
  { "file-exists",         false, true,   ((myfunc_type)(mp4h_bp_unsupported)) },
  { "real-path",           false, true,   ((myfunc_type)(mp4h_bp_unsupported)) },
#endif /* HAVE_FILE_FUNCS */

      /*  flow functions  */
  { "group",            false,    true,   ((myfunc_type)(mp4h_bp_group)) },
  { "compound",          true,    true,   ((myfunc_type)(mp4h_bp_compound)) },
  { "disjoin",          false,    true,   ((myfunc_type)(mp4h_bp_disjoin)) },
  { "noexpand",         false,    false,  ((myfunc_type)(mp4h_bp_noexpand)) },
  { "expand",           false,    true,   ((myfunc_type)(mp4h_bp_expand)) },
  { "if",               false,    false,  ((myfunc_type)(mp4h_bp_if)) },
  { "ifeq",             false,    false,  ((myfunc_type)(mp4h_bp_ifeq)) },
  { "ifneq",            false,    false,  ((myfunc_type)(mp4h_bp_ifneq)) },
  { "when",             true,     true,   ((myfunc_type)(mp4h_bp_when)) },
  { "while",            true,     false,  ((myfunc_type)(mp4h_bp_while)) },
  { "foreach",          true,     true,   ((myfunc_type)(mp4h_bp_foreach)) },
  { "var-case",         false,    false,  ((myfunc_type)(mp4h_bp_var_case)) },
  { "break",            false,    true,   ((myfunc_type)(mp4h_bp_break)) },
  { "return",           false,    true,   ((myfunc_type)(mp4h_bp_return)) },
  { "warning",          false,    true,   ((myfunc_type)(mp4h_bp_warning)) },
  { "exit",             false,    true,   ((myfunc_type)(mp4h_bp_exit)) },
  { "at-end-of-file",   true,     true,   ((myfunc_type)(mp4h_bp_at_end_of_file)) },

      /*  macro functions  */
  { "define-tag",       true,     true,   ((myfunc_type)(mp4h_bp_define_tag)) },
  { "provide-tag",      true,     true,   ((myfunc_type)(mp4h_bp_provide_tag)) },
  { "let",              false,    true,   ((myfunc_type)(mp4h_bp_let)) },
  { "undef",            false,    true,   ((myfunc_type)(mp4h_bp_undef)) },
  { "set-hook",         true,     true,   ((myfunc_type)(mp4h_bp_set_hook)) },
  { "get-hook",         false,    true,   ((myfunc_type)(mp4h_bp_get_hook)) },
  { "attributes-quote",    false, true,   ((myfunc_type)(mp4h_bp_attributes_quote)) },
  { "attributes-remove",   false, true,   ((myfunc_type)(mp4h_bp_attributes_remove)) },
  { "attributes-extract",  false, true,   ((myfunc_type)(mp4h_bp_attributes_extract)) },
  { "define-entity",    true,     true,   ((myfunc_type)(mp4h_bp_define_entity)) },

      /*  numerical relational operators  */
  { "gt",               false,    true,   ((myfunc_type)(mp4h_bp_gt)) },
  { "lt",               false,    true,   ((myfunc_type)(mp4h_bp_lt)) },
  { "eq",               false,    true,   ((myfunc_type)(mp4h_bp_eq)) },
  { "neq",              false,    true,   ((myfunc_type)(mp4h_bp_neq)) },

      /*  math functions  */
  { "add",              false,    true,   ((myfunc_type)(mp4h_bp_add)) },
  { "substract",        false,    true,   ((myfunc_type)(mp4h_bp_substract)) },
  { "multiply",         false,    true,   ((myfunc_type)(mp4h_bp_multiply)) },
  { "divide",           false,    true,   ((myfunc_type)(mp4h_bp_divide)) },
  { "modulo",           false,    true,   ((myfunc_type)(mp4h_bp_modulo)) },
  { "min",              false,    true,   ((myfunc_type)(mp4h_bp_min)) },
  { "max",              false,    true,   ((myfunc_type)(mp4h_bp_max)) },

      /*  page functions  */
  { "include",          false,   false,   ((myfunc_type)(mp4h_bp_include)) },
  { "__include",        true,     true,   ((myfunc_type)(mp4h_bp___include)) },
  { "use",              false,    true,   ((myfunc_type)(mp4h_bp_use)) },
#ifdef WITH_MODULES
  { "load",             false,    true,   ((myfunc_type)(mp4h_bp_load)) },
#else
  { "load",             false,    true,   ((myfunc_type)(mp4h_bp_unsupported)) },
#endif
  { "comment",          true,     true,   ((myfunc_type)(mp4h_bp_comment)) },
  { "set-eol-comment",  false,    true,   ((myfunc_type)(mp4h_bp_set_eol_comment)) },
  { "set-quotes",       false,    true,   ((myfunc_type)(mp4h_bp_set_quotes)) },
  { "dnl",              false,    true,   ((myfunc_type)(mp4h_bp_dnl)) },
  { "frozen-dump",      false,    true,   ((myfunc_type)(mp4h_bp_frozen_dump)) },

      /*  relational operators  */
  { "not",              false,    true,   ((myfunc_type)(mp4h_bp_not)) },
  { "and",              false,    true,   ((myfunc_type)(mp4h_bp_and)) },
  { "or",               false,    true,   ((myfunc_type)(mp4h_bp_or)) },

      /*  string functions  */
  { "downcase",         false,    true,   ((myfunc_type)(mp4h_bp_downcase)) },
  { "upcase",           false,    true,   ((myfunc_type)(mp4h_bp_upcase)) },
  { "capitalize",       false,    true,   ((myfunc_type)(mp4h_bp_capitalize)) },
  { "string-length",    false,    true,   ((myfunc_type)(mp4h_bp_string_length)) },
  { "substring",        false,    true,   ((myfunc_type)(mp4h_bp_substring)) },
  { "string-eq",        false,    true,   ((myfunc_type)(mp4h_bp_string_eq)) },
  { "string-neq",       false,    true,   ((myfunc_type)(mp4h_bp_string_neq)) },
  { "string-compare",   false,    true,   ((myfunc_type)(mp4h_bp_string_compare)) },
  { "char-offsets",     false,    true,   ((myfunc_type)(mp4h_bp_char_offsets)) },
  { "printf",           false,    true,   ((myfunc_type)(mp4h_bp_printf)) },

      /*  regexp functions  */
  { "subst-in-string",  false,    true,   ((myfunc_type)(mp4h_bp_subst_in_string)) },
  { "subst-in-var",     false,    true,   ((myfunc_type)(mp4h_bp_subst_in_var)) },
  { "match",            false,    true,   ((myfunc_type)(mp4h_bp_match)) },

      /*  variable functions  */
  { "get-var",          false,    true,   ((myfunc_type)(mp4h_bp_get_var)) },
  { "get-var-once",     false,    true,   ((myfunc_type)(mp4h_bp_get_var_once)) },
  { "set-var-x",        true,     true,   ((myfunc_type)(mp4h_bp_set_var_x)) },
  { "set-var",          false,    true,   ((myfunc_type)(mp4h_bp_set_var)) },
  { "set-var-verbatim", false,    false,  ((myfunc_type)(mp4h_bp_set_var)) },
  { "unset-var",        false,    true,   ((myfunc_type)(mp4h_bp_unset_var)) },
  { "preserve",         false,    true,   ((myfunc_type)(mp4h_bp_preserve)) },
  { "restore",          false,    true,   ((myfunc_type)(mp4h_bp_restore)) },
  { "var-exists",       false,    true,   ((myfunc_type)(mp4h_bp_var_exists)) },
  { "increment",        false,    true,   ((myfunc_type)(mp4h_bp_increment)) },
  { "decrement",        false,    true,   ((myfunc_type)(mp4h_bp_decrement)) },
  { "symbol-info",      false,    true,   ((myfunc_type)(mp4h_bp_symbol_info)) },
  { "copy-var",         false,    true,   ((myfunc_type)(mp4h_bp_copy_var)) },
  { "defvar",           false,    true,   ((myfunc_type)(mp4h_bp_defvar)) },

      /*  array functions  */
  { "array-size",       false,    true,   ((myfunc_type)(mp4h_bp_array_size)) },
  { "array-add-unique", false,    true,   ((myfunc_type)(mp4h_bp_array_add_unique)) },
  { "array-member",     false,    true,   ((myfunc_type)(mp4h_bp_array_member)) },
  { "array-push",       false,    true,   ((myfunc_type)(mp4h_bp_array_push)) },
  { "array-pop",        false,    true,   ((myfunc_type)(mp4h_bp_array_pop)) },
  { "array-topvalue",   false,    true,   ((myfunc_type)(mp4h_bp_array_topvalue)) },
  { "array-shift",      false,    true,   ((myfunc_type)(mp4h_bp_array_shift)) },
  { "array-concat",     false,    true,   ((myfunc_type)(mp4h_bp_array_concat)) },
  { "sort",             false,    true,   ((myfunc_type)(mp4h_bp_sort)) },

      /*  diversion functions  */
  { "divert",           false,    true,   ((myfunc_type)(mp4h_bp_divert)) },
  { "divnum",           false,    true,   ((myfunc_type)(mp4h_bp_divnum)) },
  { "undivert",         false,    true,   ((myfunc_type)(mp4h_bp_undivert)) },
